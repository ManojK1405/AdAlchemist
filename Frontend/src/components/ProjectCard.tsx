          ...
          {!forCommunity && (
            <div className="absolute right-3 top-3 sm:opacity-0 group-hover:opacity-100 transition flex items-center gap-2"  >
              ...
              <div className="relative">
                ...
                <ul className={`absolute right-0 mt-2 text-xs ${menuOpen ? 'block' : 'hidden'} overflow-hidden w-40 bg-black/50 backdrop-blur text-white border border-gray-500/50 rounded-lg shadow-md py-1 z-10`}>
                  {gen.generatedImage && (
